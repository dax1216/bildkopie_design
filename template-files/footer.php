	...
	<script src="<?php siteInfo('template_url'); ?>/js/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="<?php siteInfo('template_url'); ?>/js/jvectormap/jquery-jvectormap-europe-merc-en.js"></script>
	<script src="<?php siteInfo('template_url'); ?>/js/jquery.sparkline.min.js"></script>
	<script src="<?php siteInfo('template_url'); ?>/js/rickshaw/vendor/d3.v3.js"></script>
	<script src="<?php siteInfo('template_url'); ?>/js/rickshaw/rickshaw.min.js"></script>
	<script src="<?php siteInfo('template_url'); ?>/js/raphael-min.js"></script>
	<script src="<?php siteInfo('template_url'); ?>/js/morris.min.js"></script>
