	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-4 clearfix">
			...
			<ul class="list-inline links-list pull-right">	
                ...
                <li class="notifications mail dropdown">
                ...
                <li class="profile-info dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="hidden-xs">Fotograf</span>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <!-- Profile sub-links -->
                        <li>
                            <a href="<?php siteInfo('url'); ?>/backend_photographer/Konto-Kontodetails.php">
				...
				<li>
					<a href="#">
						<span class="hidden-xs">Shop Offnen</span>
